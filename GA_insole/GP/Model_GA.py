...
# 加载配置文件
with open("/Users/eric/Documents/GitHub/Parameters Optimization for Insole/GA_insole/GP/config.json", "r") as config_file:
...
toolbox.register("mutate", tools.mutPolynomialBounded, low=[b[0] for b in param_bounds], up=[b[1] for b in param_bounds], eta=1.0, indpb=0.05)
...
def main():
    ...
    # 开始进化
    for g in tqdm(range(2000), desc="进化进度"):  # 使用tqdm包装循环，提供进度条
        # 选择下一代个体
